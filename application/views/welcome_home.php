...
function handleTweets(tweets){
	...
	<div id="wps-toolbar-bottom">
        <div id="wpsc-social-accounts">
			<a href="https://76.102.117.217/about/contact-us/general-sales-contact-form" class="contact-b" title="contact us via phone or email">Contact Us</a><a href="http://www.twitter.com/learningcenter" title="find us on twitter" target="_blank"><img src="/application/image/twitter.png" alt="twitter" height="30" width="30"></a>					<a href="http://www.facebook.com/pages/Learning-Center/185529624" title="find us on facebook" target="_blank"><img src="/application/image/facebook.png" alt="facebook" height="30" width="30"></a><a href="http://www.linkedin.com/company/learning-center" title="find us on linkedin" target="_blank"><img src="/application/image/linkedin.png" alt="linkedin" height="30" width="30"></a><a href="http://www.youtube.com/user/learning center" title="find us on youtube" target="_blank"><img src="/application/image/youtube.png" alt="youtube" height="30" width="30"></a><a href="http://pinterest.com/learningcenter/" title="find us on pinterest" target="_blank"><img src="/application/image/pinterest.png" alt="pinterest" height="30" width="30"></a>
            </div>
...
<ul id="menu-main" class="superfish nav clearfix sf-js-enabled">
	<li id="menu-item-219" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-219">
		...
		<ul style="display: none; visibility: hidden;" class="sub-menu">
			...
			<li id="menu-item-1025" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1025"><a href="http://76.102.117.217index.php/php">PHP</a></li>
			...
			<li id="menu-item-1080" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1080"><a href="http://76.102.117.217/index.php/javascript">Javascript/AJAX</a></li>
			<li id="menu-item-1080" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1080"><a href="http://76.102.117.217/html">HTML/CSS</a></li>
		</ul>
	</li>
	<li id="menu-item-3974" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3974">
		<a class="sf-with-ul" href="http://76.102.117.217/index.php/lamp">JAVA<span class="sf-sub-indicator"> »</span></a>
		<ul style="display: none; visibility: hidden;" class="sub-menu">
			<li id="menu-item-2342" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2342"><a class="sf-with-ul" href="http://76.102.117.217/index.php/java">JAVA<span class="sf-sub-indicator"> »</span></a>
				<ul style="display: none; visibility: hidden;" class="sub-menu">
					<li id="menu-item-3387" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3387"><a href="http://76.102.117.217/index.php/jboss">JBOSS</a></li>
					<li id="menu-item-3388" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3388"><a href="http://76.102.117.217/index.php/servlet">SERVLET</a></li>
				</ul>
			</li>
		</ul>			
	</li>
...
<p>In this section , It will give you some tips and examples for LAMP learners. There are some perl, php, mysql, linux , memcached and apache  tutorials ,  how to install, configure, and start/stop serveries  apache and Memcached in Centos.</p>
...
<li>3) Linux commands </li>
<li>4) Monitoring tools </li>
</ul>
...
<p>Just like most of our tutorials, if you want to test the final result
 of this tutorial, |learning center| has provided a complete JBoss 7
