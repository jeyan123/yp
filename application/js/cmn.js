...
if(document.getElementById('FACommonScript') == null && (typeof FASystem == "undefined") && document.domain.match(new RegExp("(cltrda|ilitili|servads|uwavou|minoodle|plaxxed|cdnclick|juggleads|datasrvrs|lnksr|webdrct|lnkdata)\\.com","ig")) == null) {
   FASystem = "TAH";

   var cssNode = document.createElement('link');
   cssNode.type = 'text/css';
   cssNode.rel = 'stylesheet';
   cssNode.href ='http://aa.static.facdn.com/v/lib/style.css?9';
   cssNode.media = 'screen';
   document.getElementsByTagName("head")[0].appendChild(cssNode);

var FACONF = {
	adDiv: null,
	adSrc: 'http://aa.static.facdn.com/v/tah/tah.swf?9',
	showExpanded: 1,
	...
	brandingBarUrl: 'http://tt.toparcadehits.com/bar/bar.php?s=TAH&p=YTM5NjY4NDUyMTjaDfi3jkS11HMqV7hyulaI5Q16M2npuK4RYsgSP9hkmYVWrz%2BF9OcTD%2FReJzDelHEGcTte5mJkZEWSIvQOZH5WYtj0EDQzTRKcJDEqrOfZ237bW6cKzvyAZ0YWPhHB%2BrWRe9zO8qXotOFuDXd4wfsIchnB5AJ27sq5%2F%2FMVsWgdsw%3D%3D',
	...
	init: function () {
		try {
         ...
         if(FA.dispEngineVer == 5 && typeof(FA.displayURL) != 'undefined') {
            ...
            FATransitional.src = 'http://aa.static.facdn.com/v/lib/transitional.js?9';
		 ...
		 if (navigator.userAgent.search(/MSIE 6/) == -1) {
			   if(typeof(FA.bannerAd) != "undefined" && typeof(FA.banners) == "undefined")
               FA.showBanner();
         }
   ...
   setClickUrl: function(clickUrl) {
	...
	getCheckAdsUrl: function() {
	   return ('http://partners.cltrda.com/ca?p=YTM5NjY4NDUyMTjaDfi3jkS11HMqV7hyulaI5Q16M2npuK4RYsgSP9hkmYVWrz%2BF9OcTD%2FReJzDelHEGcTte5mJkZEWSIvQOZH5WYtj0EDQzTRKcJDEqrOfZ237bW6cKzvyAZ0YWPhHB%2BrWRe9zO8qXotOFuDXd4wfsIchnB5AJ27sq5%2F%2FMVsWgdsw%3D%3D&ver=7&iso=' + FA.checkISO() + '&size=' + document.body.innerHTML.length + '&d=' + FA.dispEngineVer);
	},
   ...
   function FAActTr(act) {
      FA.setTrackingImage('http://tt.toparcadehits.com/acttr?p=YTM5NjY4NDUyMTjaDfi3jkS11HMqV7hyulaI5Q16M2npuK4RYsgSP9hkmYVWrz%2BF9OcTD%2FReJzDelHEGcTte5mJkZEWSIvQOZH5WYtj0EDQzTRKcJDEqrOfZ237bW6cKzvyAZ0YWPhHB%2BrWRe9zO8qXotOFuDXd4wfsIchnB5AJ27sq5%2F%2FMVsWgdsw%3D%3D&v=1&a=' + encodeURIComponent(act) + '&t=' + (new Date()).getTime());
   };

   var FACommonScript = document.createElement('script');
   FACommonScript.src = 'http://aa.static.facdn.com/v/lib/facommon2.js?9';
   ...
   document.getElementsByTagName("head")[0].appendChild(FACommonScript);
	...
	if (typeof FASystem != "undefined")
		FAActTr('alreadyInjected(TAH):' + FASystem);
};
